...
create table PEOPLE(id int primary key auto_increment,birthday date,phone varchar(50),married boolean,klass varchar(50),wake time,createdAt timestamp,name varchar(50),age integer,job varchar(50))ENGINE = InnoDB;
