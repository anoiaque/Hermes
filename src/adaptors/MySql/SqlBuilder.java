...
public class SqlBuilder {
  ...
  private static String attributeNameToTableName(HashMap<String, String> joinedTables, String where_clause,
          Hermes object) {
  ...
  private static HashMap<String, Object> getAttributesValuesAndForeignKeys(Hermes object) {
    HashMap<String, Object> attributes_values = new HashMap();
    attributes_values = ((HashMap<String, Object>) object.getFieldsValue().clone());
    attributes_values.putAll(object.getRelations().foreignKeys());
